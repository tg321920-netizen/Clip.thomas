...
export class YouTubeProvider {
  ...
  requirements() {
    return {
      ...
      notes: [
        "Shorts use the normal YouTube video upload API; vertical short videos are classified by YouTube.",
        "Unverified API projects created after July 28, 2020 can be restricted to private uploads until an audit is completed.",
      ],
    };
  }
  ...
  async publish(context) {
    ...
    return {
      ...
      providerStatus: body?.status?.uploadStatus || "uploaded",
      raw: body,
    };
  }
  ...
  async getStatus(context) {
    ...
    url.searchParams.set("part", "status,statistics");
